...
/* RICERCA SEQUENZIALE O ESAUSTIVA
 *******************************************************************************
 ...
 * all'interno della variabile di tipo interi pos sara' inserito l'indice della
...
int main(int argc, char *argv[])
{
	...
	/* Riempie un array di MAX_ARR_SIZE elementi con valori casuali che vanno
	 * da uno a MAX_ARR_SIZE */
