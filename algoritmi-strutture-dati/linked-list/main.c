...
void InserisciCodaLista(TipoLista *lis, int elem);
...
int main(int argc, char *argv[])
{
   ...
   printf("-----------------------\n");
   ScorriLista(new_nodo);
   InserisciCodaLista(&new_nodo, 1973);
   InserisciTestaLista(&new_nodo, 1);
   InserisciCodaLista(&new_nodo, 0);
   printf("-----------------------\n");
   ScorriLista(new_nodo);
   CancellaTesta(&new_nodo);
   ...
   InserisciCodaLista(&new_nodo_2, 2000);
   InserisciCodaLista(&new_nodo_2, 3000);
   ...
   InserisciCodaLista(&new_nodo_2, 9);
   InserisciCodaLista(&new_nodo_2, 3);
   ...
   InserisciTestaLista(&new_nodo_2, 100);
   InserisciCodaLista(&new_nodo_2, 100);
   printf("-----------------------\n");
   ScorriLista(new_nodo_2);
   printf("-----------------------\n");
