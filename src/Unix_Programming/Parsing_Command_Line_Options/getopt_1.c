...
valida e la getopt() restituisce il carattere '?'; se invece l'opzione e'
presente nella stringa shortopts, la getopt() verifica se questa opzione
accetta o meno un parametro, controllando la presenza del simbolo ':' dopo il
carattere stesso, in shortopts.
...
getopt() restituirebbe il carattere ':'.
*/
