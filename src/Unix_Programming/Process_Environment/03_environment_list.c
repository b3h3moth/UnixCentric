...
main(), una 'environment list', ovvero un puntatore ad un vettore di array
NULL-terminated, all'interno del quale ciascuna stringa indica una variabile 
...
della definizione delle variabili d'ambiente, per cui non ISO C.
